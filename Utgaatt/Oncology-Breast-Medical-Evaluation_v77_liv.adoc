...
TemplateId:: Oncology-Breast-Medical-Evaluation_v77_liv
...
For eksempel "Lever", "Høyre ankel" eller "Lymfeknutegruppe". Det er anbefalt å kode kroppsstruktur med en passende terminologi, som SNOMED CT. Dersom den aktuelle strukturen i kroppen er fullt ut angitt i dette "Kroppsstruktur"-elementet er det ikke nødvendig å bruke "Anatomisk lokalisasjon" eller "Strukturert anatomisk lokalisasjon".
...
* cTX (no.onk.tmn: TX)
* cT0 (no.onk.tmn: T0)
* cTis(DCIS) (no.onk.tmn: Tis(DIS))
* cTis(Paget) (no.onk.tmn: Tis(Paget))
* cT1 (no.onk.tmn: T1)
* cT1mi (no.onk.tmn: T1mi)
* cT1a (no.onk.tmn: T1a)
* cT1b (no.onk.tmn: T1b)
* cT1 (no.onk.tmn: T1)
* cT2 (no.onk.tmn: T2)
...
* pTX (no.onk.tmn: TX)
* pT0 (no.onk.tmn: T0)
* pTis(DCIS) (no.onk.tmn: Tis(DCIS))
* pTis(Paget) (no.onk.tmn: Tis(aget))
* pT1 (no.onk.tmn: T1)
* pT1mi (no.onk.tmn: T1mi)
* pT1a (no.onk.tmn: T1a)
* pT1b (no.onk.tmn: T1b)
* pT1c (no.onk.tmn: T1c)
* pT2 (no.onk.tmn: T2)
...
* pNX (no.onk.tmn: NX)
* pN0 (no.onk.tmn: N0)
* pN0(i-) (no.onk.tmn: N0(i-))
* pN0(i+) (no.onk.tmn: N0(i+))
* pN0(mol-) (no.onk.tmn: N0(mol-))
* pN0(mol+) (no.onk.tmn: N0(mol+))
* pN1mi (no.onk.tmn: N1mi)
* pN1 (no.onk.tmn: N1)
* pN1a (no.onk.tmn: N1a)
* pN1b (no.onk.tmn: N1b)
* pN1c (no.onk.tmn: N1c)
